...
public record TaskDetailResponse(
        ...
        @JsonProperty("planOutput") String planOutput,
        @JsonProperty("testOutput") String testOutput,
        @JsonProperty("testReviewOutput") String testReviewOutput,
        @JsonProperty("codeOutput") String codeOutput,
        @JsonProperty("reviewOutput") String reviewOutput,
